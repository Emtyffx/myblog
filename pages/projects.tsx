...
const Projects: NextPage<ProjectProps> = ({data}) => {
  return (
    <div className="App container absolute pl-4 top-0 left-0 bottom-0 right-0 flex transition duration-500 flex-col justify-center">
      <TopBar />
      <h1 className='text-4xl mb-2'>My github repos</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        {data &&
          data.filter(repo => !repo.private).map((repo, index) => (
